...
public class OptClassInitDerived1 extends OptClassInit {

    private ConstructorDecl ConstructorDecl;
    private MethodDeclList MethodDeclList;

    public OptClassInitDerived1 (ConstructorDecl ConstructorDecl, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("OptClassInitDerived1(\n");
